  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#070711] relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        {[
          { top: '12%', left: '15%', color: 'bg-indigo-400', delay: '0s', dur: '6s' },
          { top: '25%', left: '82%', color: 'bg-pink-400', delay: '1.2s', dur: '8s' },
          { top: '60%', left: '8%', color: 'bg-cyan-400', delay: '0.6s', dur: '7s' },
          { top: '75%', left: '70%', color: 'bg-indigo-400', delay: '2s', dur: '9s' },
          { top: '88%', left: '40%', color: 'bg-pink-400', delay: '1s', dur: '6s' },
        ].map((d, i) => (
          <div
            key={i}
            className={`absolute w-1.5 h-1.5 rounded-full ${d.color} opacity-60`}
            style={{
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center text-center mb-8">
            ...
            <p className="text-white/40 text-sm">Sign in to sync your vibe</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-white/25 pointer-events-none" />
                <input
                  type="email"
                  value={email}
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-xs font-bold text-white/45 tracking-widest uppercase">
                  Password
                </label>
                <a href="#" className="text-indigo-400/80 text-xs hover:text-indigo-300 transition-colors">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-4.5 h-4.5 text-white/25 pointer-events-none" />
                <input
                  type="password"
                  value={password}
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-white/25 text-xs">New here?</span>
            <div className="flex-1 h-px bg-white/[0.06]" />
          </div>
          ...
          <Link
            to="/register"
            className="block w-full text-center py-3.5 rounded-2xl border border-white/[0.08] bg-white/[0.03] text-white/65 font-semibold text-sm hover:bg-indigo-500/12 hover:border-indigo-500/40 hover:text-white transition-all duration-200"
          >
            Create an account →
          </Link>
        </div>
